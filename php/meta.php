...
class Meta
{
     ...
     * @return PDOStatement
     */
    public static function Nuevo_Registro($latitud, $longitud, $cantidad_pasos, $fecha, $hora)
    {        
        // Sentencia INSERT
        $comando = "INSERT INTO registros (latitud, longitud, cantidad_pasos, fecha, hora) VALUES (?,?,?,?,?)";

        // Preparar la sentencia
        $sentencia = Database::getInstance()->getDb()->prepare($comando);

        return $sentencia->execute(array($latitud, $longitud, $cantidad_pasos, $fecha, $hora));
